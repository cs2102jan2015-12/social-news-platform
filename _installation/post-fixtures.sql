...
VALUES ("Monster", "I'm just a man with a candle to guide me.", CURDATE(), 1);
INSERT INTO Post (title, content, submitted, author)
VALUES ("My Little Musings", "I believe there is a God, but I'm not sure he believes in us.", CURDATE(), 2);
...
VALUES ("OMG! I love that song!", CURDATE(), 2, 1);
INSERT INTO Comment (content, submitted, author, parent)
VALUES ("IKR!! I'm taking a stand to escape what's inside me~", CURDATE(), 1, 1);
INSERT INTO Comment (content, submitted, author, parent)
VALUES ("Wah. Why so emo one?", CURDATE(), 1, 2);
INSERT INTO Comment (content, submitted, author, parent)
VALUES (":P Just feeling weird today.", CURDATE(), 2, 2);
