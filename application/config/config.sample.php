...
define('URL_SUB_FOLDER', 'social-news-platform'); // This is the folder containing our repository.
...
define('DB_HOST', 'c9username-appname-xxxxxxx'); // mysql> SHOW VARIABLES WHERE Variable_name = 'hostname';
define('DB_NAME', 'social_news_platform');
define('DB_USER', 'c9username'); // Cloud9 username.
define('DB_PASS', '');
