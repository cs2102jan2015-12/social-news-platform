...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (!$this->url_controller) {
            ...
            $this->url_controller = $this->url_controller . 'controller'; // Add 'controller' to end of name.
            $this->url_controller = new $this->url_controller(); // Instantiate the controller (case-insensitive).
